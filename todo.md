...
- [] 1. Add specs to store history of games in local storage - should store full move history for the game as well as win/loss result.
- [] 2. Use the game history to allow a replay of a game.
