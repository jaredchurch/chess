...
export function buildBishop(group, mat) {
    ...
    // NODULE: Cylinder (r=0.16, h=0.18) at y=0.58
    add(new THREE.CylinderGeometry(0.16, 0.18, 0.05, 24), 0.58);
    // NECK: Cylinder (r=0.08, h=0.22) at y=0.70
    add(new THREE.CylinderGeometry(0.08, 0.10, 0.22, 24), 0.70);
    // MITRE: Cone (r=0.08, h=0.26) at y=0.92
    add(new THREE.ConeGeometry(0.12, 0.26, 24), 0.92);    
}
