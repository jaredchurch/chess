...
- [] BUG2. when a move is reviewed the dialog pops up but the board displayed has some squares are shorter than they should be. all the squares should be squares.