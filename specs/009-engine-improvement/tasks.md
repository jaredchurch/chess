...
## Phase1: Infrastructure & Positional Evaluation

- [x] T001 Define `DifficultyLevel` enum and update `get_best_move` signature in `src/ai/mod.rs`
- [x] T002 Implement Piece-Square Tables (PST) for all pieces in `src/ai/evaluation.rs`
- [x] T003 Implement basic Minimax search with Alpha-Beta pruning in `src/ai/search.rs`
- [x] T004 Implement Level 1 (Novice) with randomness in `src/ai/search.rs`
- [x] T005 Implement Levels 3 & 4 (Casual, Intermediate) using Alpha-Beta and PST
